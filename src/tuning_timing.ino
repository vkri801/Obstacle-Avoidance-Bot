...
long TUNING_STARTED;
#define TUNING_WHAT PATHFINDING_TURN_DURATION_MILLIS
#define TUNING_MOTOR_ACTION Robot::motor_controller->stop()
...
void loop()
{
    ...
    if (Battery::ok())
    {
        ...
        if ((millis() - TUNING_STARTED) >= TUNING_WHAT)
        {
